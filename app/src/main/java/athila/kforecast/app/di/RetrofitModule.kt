...
class RetrofitModule {
  ...
  @Provides
  @Singleton
  @FirebaseRetrofit fun provideFirebaseRetrofit(baseRetrofitBuilder: Retrofit.Builder): Retrofit = baseRetrofitBuilder.baseUrl(
      FIREBASE_BASE_URL).build()

  @Provides
  @Singleton
  @ForecastRetrofit fun provideForecastRetrofit(baseRetrofitBuilder: Retrofit.Builder): Retrofit = baseRetrofitBuilder.baseUrl(
